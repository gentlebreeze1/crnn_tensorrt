...
height = 416
width = 416
CALIB_IMG_DIR = '/data/zhangyong/mypytoch/yolov5-master/car'
onnx_model_path = "/data/zhangyong/pytorch/yolov5-master/car/train/exp/weights/car.onnx"
...
def main():
    ...
    int8_mode = False
    #CALIB_IMG_DIR = '/data/zhangyong/mypytoch/yolov5-master/car'
    onnx_model_path = "/data/zhangyong/shenli/crnn_cn_pt-master/mycrnn-sim.onnx"
    print('*** onnx to tensorrt begin ***')
    # calibration
    calibration_stream = DataLoader()
    engine_model_path = "model/mycrnn7.trt"
